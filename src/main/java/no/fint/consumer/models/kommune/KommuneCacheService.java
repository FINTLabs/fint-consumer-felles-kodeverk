...
@Slf4j
@Service
public class KommuneCacheService extends CacheService<FintResource<Kommune>> {
    ...
    public KommuneCacheService() {
        super(MODEL, KodeverkActions.GET_ALL_KOMMUNE);
    }
    ...
    public void onAction(Event event) {
        update(event, new TypeReference<List<FintResource<Kommune>>>() {
        });
    }
}
